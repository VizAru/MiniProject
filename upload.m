...
% UPLOAD MATLAB code for upload.fig
...
% Last Modified by GUIDE v2.5 25-Nov-2018 10:31:02
...
a=imread(name);
I2 = Thersholding(a);
croppedImage = I2(110:750, 100:940);
...
dlmwrite('train.csv',Area,'delimiter',',');
set(handles.edit3,'string',Area(1));
set(handles.edit4,'string',Area(2));
...
X_test_w_best_features = csvread('train.csv');
are=csvread('train.csv');
result = predict(Md1, X_test_w_best_features);
%disp(result);
if result == 1 && are(1)< 160000
    set(handles.edit6,'string','Affected');
else
    set(handles.edit6,'string','NotAffected');
end
